<template>
	<div class="orders">
		...
		<el-card class="box-card">
			...
			<el-table :data="orderslist" style="width: 100%">
				...
				<el-table-column label="操作">
					<template slot-scope="scope">
						<el-button type="primary" size="mini" icon="el-icon-edit" @click="editadss"></el-button>
						<el-button type="danger" size="mini" icon="el-icon-location" @click="logistics(scope.row)"></el-button>
					</template>
				</el-table-column>
			</el-table>
		...
		<EditordersVue ref="editorder" />

		<KuaiDi ref="keaidi"></KuaiDi>
	</div>
</template>

<script>
import EditordersVue from './Editorders.vue'
...
export default {
	...
	methods: {
		...
		editadss() {
			this.$refs.editorder.editShow = true
		}
